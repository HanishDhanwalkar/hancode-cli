...
except ImportError:  # pragma: no cover - optional in the starter workspace
...
def base_url_hostname(base_url: str) -> str:
    """Return the hostname portion of a URL or host string."""
...
def base_url_host_matches(base_url: str, host: str) -> bool:
    """Return True when *base_url* contains the supplied host string."""
    return host.lower() in base_url_hostname(base_url)
